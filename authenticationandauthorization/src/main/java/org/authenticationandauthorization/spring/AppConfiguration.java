package org.authenticationandauthorization.spring;
...
@Configuration
@ComponentScan({ "org.authenticationandauthorization" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.authenticationandauthorization");
                servletContext.setInitParameter("tapestry.development-modules", "org.authenticationandauthorization.services.DevelopmentModule");
